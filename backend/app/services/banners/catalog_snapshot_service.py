...
def _configured_service_for_team(team_id_override: str | None = None) -> CatalogSnapshotService:
...
def configured_service_for_team(team_id: str) -> CatalogSnapshotService:
